...
public:
	...
	inline static int set_ev_bit(int fd, int bit)
		{ return ioctl(fd, UI_SET_EVBIT, bit); }
	inline static int set_key_bit(int fd, int bit)
		{ return ioctl(fd, UI_SET_KEYBIT, bit); }
	inline static int set_rel_bit(int fd, int bit)
		{ return ioctl(fd, UI_SET_RELBIT, bit); }
	inline static int set_abs_bit(int fd, int bit)
