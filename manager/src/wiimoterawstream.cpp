...
WiimoteRawStream::WiimoteRawStream(WiimotedevDeviceEvents *iface, InfraredCameraView *graphics, QWidget *parent)
	...
	ui->setupUi(this);
	QLabel *label;
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusClassicControllerPlugged, this, &WiimoteRawStream::dbusClassicPlugged);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusClassicControllerUnplugged, this, &WiimoteRawStream::dbusClassicUnplugged);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusClassicControllerRStick, this, &WiimoteRawStream::dbusClassicControllerRStick);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusClassicControllerLStick, this, &WiimoteRawStream::dbusClassicControllerLStick);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusNunchukAcc, this, &WiimoteRawStream::dbusNunchukAcc);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusNunchukPlugged, this, &WiimoteRawStream::dbusNunchukPlugged);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusNunchukUnplugged, this, &WiimoteRawStream::dbusNunchukUnplugged);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusNunchukStick, this, &WiimoteRawStream::dbusNunchukStick);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusVirtualCursorPosition, this, &WiimoteRawStream::dbusVirtualCursorPosition);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusVirtualCursorFound, this, &WiimoteRawStream::dbusVirtualCursorFound);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusVirtualCursorLost, this, &WiimoteRawStream::dbusVirtualCursorLost);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteConnected, this, &WiimoteRawStream::dbusWiimoteConnected);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteDisconnected, this, &WiimoteRawStream::dbusWiimoteDisconnected);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteAcc, this, &WiimoteRawStream::dbusWiimoteAcc);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteBatteryLife, this, &WiimoteRawStream::dbusWiimoteBatteryLife);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteGeneralButtons, this, &WiimoteRawStream::dbusWiimoteGeneralButtons);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteInfrared, this, &WiimoteRawStream::dbusWiimoteInfrared);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteLedStatusChanged, this, &WiimoteRawStream::dbusWiimoteLedStatusChanged);
	QObject::connect(iface, &WiimotedevDeviceEvents::dbusWiimoteRumbleStatusChanged, this, &WiimoteRawStream::dbusWiimoteRumbleStatusChanged);
	...
	label->setMargin(2);
	connect(m_wiimotePoints[0], &QAction::triggered, this, &WiimoteRawStream::pressedPoint1);
	connect(m_wiimotePoints[1], &QAction::triggered, this, &WiimoteRawStream::pressedPoint2);
	connect(m_wiimotePoints[2], &QAction::triggered, this, &WiimoteRawStream::pressedPoint3);
	connect(m_wiimotePoints[3], &QAction::triggered, this, &WiimoteRawStream::pressedPoint4);
	connect(m_classicConnected, &QAction::triggered, this, &WiimoteRawStream::pressedClassic);
	connect(m_nunchukConnected, &QAction::triggered, this, &WiimoteRawStream::pressedNunchuk);
	connect(m_cursorVisible, &QAction::triggered, this, &WiimoteRawStream::pressedCursor);
	connect(m_wiimoteLeds[0], &QAction::triggered, this, &WiimoteRawStream::toggleLed1);
	connect(m_wiimoteLeds[1], &QAction::triggered, this, &WiimoteRawStream::toggleLed2);
	connect(m_wiimoteLeds[2], &QAction::triggered, this, &WiimoteRawStream::toggleLed3);
	connect(m_wiimoteLeds[3], &QAction::triggered, this, &WiimoteRawStream::toggleLed4);
	connect(m_wiimoteRumble, &QAction::triggered, this, &WiimoteRawStream::toggleRumble);
