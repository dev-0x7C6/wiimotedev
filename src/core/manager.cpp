...
bool ConnectionManager::registerConnection(WiimoteConnection *connection)
{
  ...
  if (settings->dbusInterfaceSupport()) {
    connect(connection, SIGNAL(dbusVirtualCursorPosition(quint32,quint32,quint32,quint32,double)), dbusDeviceEventsAdaptor, SIGNAL(dbusVirtualCursorPosition(quint32,quint32,quint32,quint32,double)), Qt::QueuedConnection);
